...
func TestBootstrapReadme(t *testing.T) {
	...
	if err := goagen("./readme", "bootstrap", "-d", "github.com/Gys/goa/_integration_tests/readme/design"); err != nil {
		t.Error(err.Error())
	}
...
func TestDefaultMedia(t *testing.T) {
	...
	if err := goagen("./media", "bootstrap", "-d", "github.com/Gys/goa/_integration_tests/media/design"); err != nil {
		t.Error(err.Error())
	}
...
func TestCellar(t *testing.T) {
	...
	if err := goagen("./goa-cellar", "bootstrap", "-d", "github.com/Gys/goa-cellar/design"); err != nil {
		t.Error(err.Error())
	}
...
func goagen(dir, command string, args ...string) error {
	pkg, err := build.Import("github.com/Gys/goa/goagen", "", 0)
	if err != nil {
		return err
	}
