...
var _ = Describe("Validation", func() {
	...
	Describe("EncoderDefinition", func() {
		...
		BeforeEach(func() {
			enc = &EncodingDefinition{MIMETypes: []string{"application/foo"}, Encoder: true, PackagePath: "github.com/Gys/goa/encoding/foo"}
			...
			cellarPath = path.Join(oldWorkingDir, "tmp_gopath/src/github.com/Gys/goa_fake_cellar")
		...
		Context("with package in vendor", func() {
			BeforeEach(func() {
				packagePath := path.Join(cellarPath, "vendor/github.com/Gys/goa/encoding/foo")
