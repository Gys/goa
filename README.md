...
## This branch is deprecated, use the [v3 branch](https://github.com/Gys/goa/tree/v3) for the latest.
...
[![Sourcegraph](https://sourcegraph.com/github.com/Gys/goa/-/badge.svg)](https://sourcegraph.com/github.com/Gys/goa?badge)
[![Godoc](https://godoc.org/github.com/Gys/goa?status.svg)](http://godoc.org/github.com/Gys/goa)
[![Slack](https://img.shields.io/badge/slack-gophers-orange.svg?style=flat)](https://gophers.slack.com/messages/goa/)

## V2

[goa v2](https://github.com/Gys/goa/tree/v2) is currently in beta:
...
For example displaying the docs for `github.com/Gys/goa-cellar/design` is
done by browsing to:
...
The [examples](https://github.com/Gys/examples) repo contains simple examples illustrating
basic concepts.

The [goa-cellar](https://github.com/Gys/goa-cellar) repo contains the implementation for a
